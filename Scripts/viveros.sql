...
START TRANSACTION;
USE `viveros`;
INSERT INTO `viveros`.`CLIENTE` (`DNI_Cliente`, `Nombre`, `Bonificacion`, `Metodo_Pago`, `Gasto_Mensual`) VALUES ('132457689O', 'Pedro', 15, 'Efectivo', 150.00);
INSERT INTO `viveros`.`CLIENTE` (`DNI_Cliente`, `Nombre`, `Bonificacion`, `Metodo_Pago`, `Gasto_Mensual`) VALUES ('102938475F', 'Juan', 30, 'Tarjeta', 350.00);
INSERT INTO `viveros`.`CLIENTE` (`DNI_Cliente`, `Nombre`, `Bonificacion`, `Metodo_Pago`, `Gasto_Mensual`) VALUES ('019283746G', 'Lucas', 10, 'Tarjeta', 50.00);
...
START TRANSACTION;
USE `viveros`;
INSERT INTO `viveros`.`PRODUCTOPEDIDO` (`Codigo_Barras`, `Cod_Pedido`) VALUES (1111, 1);
INSERT INTO `viveros`.`PRODUCTOPEDIDO` (`Codigo_Barras`, `Cod_Pedido`) VALUES (2222, 1);
INSERT INTO `viveros`.`PRODUCTOPEDIDO` (`Codigo_Barras`, `Cod_Pedido`) VALUES (1111, 2);
INSERT INTO `viveros`.`PRODUCTOPEDIDO` (`Codigo_Barras`, `Cod_Pedido`) VALUES (3333, 2);
INSERT INTO `viveros`.`PRODUCTOPEDIDO` (`Codigo_Barras`, `Cod_Pedido`) VALUES (2222, 3);
INSERT INTO `viveros`.`PRODUCTOPEDIDO` (`Codigo_Barras`, `Cod_Pedido`) VALUES (3333, 3);
